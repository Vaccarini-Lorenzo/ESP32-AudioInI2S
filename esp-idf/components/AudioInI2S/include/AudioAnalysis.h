...
#ifndef ESP32_AUDIOINI2S_AUDIOANALYSIS_H
#ifndef SAMPLE_SIZE
...
#define BAND_SIZE 8
#endif
#define ESP32_AUDIOINI2S_AUDIOANALYSIS_H
#include "stdint.h"

class AudioAnalysis {
public:
    char TAG[20] = "AudioAnalysis";
    enum falloff_type{
        NO_FALLOFF,
        LINEAR_FALLOFF,
        ACCELERATE_FALLOFF,
    ...
    void autoLevel(falloff_type falloffType = ACCELERATE_FALLOFF, float falloffRate = 0.01, float min = 10, float max = -1); // auto balance normalized values to ambient noise levels.
...
#endif //ESP32_AUDIOINI2S_AUDIOANALYSIS_H
